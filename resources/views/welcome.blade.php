...
@section('content')
    ...
    <section class="slider">
        <div class="hero-slider">
            <!-- Start Single Slider -->
            <div class="single-slider" style="background-image: url('/frontend/assets/img/slider2.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
            ...
            <!-- End Single Slider -->
            <!-- Start Single Slider -->
            <div class="single-slider" style="background-image: url('/frontend/assets/img/slider.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
            ...
            <!-- Start End Slider -->
            <!-- Start Single Slider -->
            <div class="single-slider" style="background-image: url('/frontend/assets/img/slider3.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="text">
                ...
                <div class="col-lg-6 col-12">
                    ...
                    <div class="choose-right">
                        <div class="video-image">
                            ...
                            <!--/ End Video Animation -->
                            <a href="https://www.youtube.com/watch?v=f9P7_qWrf38&list=RDMMlRsaDQtYqAo&index=8"
            ...
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="owl-carousel portfolio-slider">
                        <div class="single-pf">
                            <img src="/frontend/assets/img/pf1.jpg" alt="#" />
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="/frontend/assets/img/pf2.jpg" alt="#" />
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="/frontend/assets/img/pf3.jpg" alt="#" />
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="/frontend/assets/img/pf4.jpg" alt="#" />
                            <a href="portfolio-details.html" class="btn">View Details</a>
                        </div>
                        <div class="single-pf">
                            <img src="/frontend/assets/img/pf1.jpg" alt="#" />
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="/frontend/assets/img/blog1.jpg" alt="#" />
                        </div>
                        <div class="news-body">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="/frontend/assets/img/blog2.jpg" alt="#" />
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="news-head">
                            <img src="/frontend/assets/img/blog3.jpg" alt="#" />
                        </div>
                        <div class="news-body">
                            <div class="news-content">
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="owl-carousel clients-slider">
                        <div class="single-clients">
                            <img src="/frontend/assets/img/client1.png" alt="#" />
                        </div>
                        <div class="single-clients">
                            <img src="/frontend/assets/img/client2.png" alt="#" />
                        </div>
                        <div class="single-clients">
                            <img src="/frontend/assets/img/client3.png" alt="#" />
                        </div>
                        <div class="single-clients">
                            <img src="/frontend/assets/img/client4.png" alt="#" />
                        </div>
                        <div class="single-clients">
                            <img src="/frontend/assets/img/client5.png" alt="#" />
                        </div>
                        <div class="single-clients">
                            <img src="/frontend/assets/img/client1.png" alt="#" />
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    <form class="form" id="sendRequestForm" action="{{ route('customer.send-request') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <input type="datetime-local" name="reception_time" id=""
                                        placeholder="Thời gian" class="@error('reception_time') is-invalid @enderror">
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    <textarea name="support_request" placeholder="Nhập yêu cầu....."
                                        class="@error('support_request') is-invalid @enderror"></textarea>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="appointment-image">
                        <img src="/frontend/assets/img/contact-img.png" alt="#" />
                    </div>
                </div>
            </div>
        </div>
...
@endsection
@section('js')
    <script src="{{ asset('frontend/assets/js/custom/send-request.js') }}"></script>
@endsection
