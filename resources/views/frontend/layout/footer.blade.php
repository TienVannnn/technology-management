        ...
        <div class="button-contact" id="phone-vr">
            <div class="phone-vr">
                ...
                <div class="phone-vr-img-circle">
                    <a class="pps-btn-img" href="tel:+84904162666" alt="Gọi điện thoại" style="text-decoration: none"><i
...
<div class="item-social-network">
    <a href="#" class="linkSocial" title="Message">
        <img data-src="/frontend/assets/img/icon-message.png" class="glowing lazyloaded" alt="Messenger"
            src="/frontend/assets/img/icon-message.png">
    </a>
</div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <ul>
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>About
                                            Us</a>
                                    </li>
                                    <li>
